...
This is a [[designpatterns]] that's pretty common in Figma, but can also be helpful in components, or just [[react]] generally. Figma now has official support for Slots too.
...
Personally, I don't use the API too much as it's a bit clunky. I usually tend for [[20220801045634-design-system-subcomponents]]. The benefit of slots is that it's intentionally a bit more restrictive, which can be helpful.

https://medium.com/@nathanacurtis/slots-in-design-systems-f53698c2d745
