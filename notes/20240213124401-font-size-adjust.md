...
This can be useful when you're mixing two fonts within a sentence, e.g. a monospace font for code and a regular font for copy. Or for avoiding shifts when fallback fonts are loaded.
