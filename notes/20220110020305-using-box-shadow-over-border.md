...
Using an inset box-shadow in particular means that you're applying a stroke 'on top' of the element, which means the shadow does not exceed the bounds of the components when used in things with overflow. 
